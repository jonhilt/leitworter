...
4. A public source: person, date, URL. For classics from books, name the book and the public post that treats the phrase as a Leitwort. No anonymous "works for me."
...
| Leitwort | Book |
|---|---|
| [Tracer bullets](entries/tracer-bullets.md) | Hunt and Thomas, *The Pragmatic Programmer* |
| [Deep modules](entries/deep-modules.md) | Ousterhout, *A Philosophy of Software Design* |
| [Test seams](entries/test-seams.md) | Feathers, *Working Effectively with Legacy Code* |
...
Quoted prompts stay with their authors. Book concepts stay attributed to their authors. The repo structure and our notes are MIT. See [LICENSE](LICENSE).
